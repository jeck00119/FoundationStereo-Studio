...
# the ONE loader + pair-discovery module, shared with the Input panel and the
# calibration CLI (studio.pairs) — a batched pair is by construction fed to the
# engine exactly as a hand-dropped one
from .pairs import PairScan, find_pairs, load_rgb  # noqa: F401  (re-exported for callers)
